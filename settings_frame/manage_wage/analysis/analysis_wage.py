...
from settings_frame.manage_wage.analysis import by_staff, retiree
from settings_frame.manage_wage.analysis import by_month
from settings_frame.manage_wage.analysis import by_month2


class Analysis_Wage:
    def __init__(self, parent):
        self.window = UI_setting.new_Window(parent, "Analysis")
...
#        self.btn_list = [self.btn_by_month]
        return
    ...
    def set_Data_Frame(self, parent):
        ...
        self.frames = {}
#        for F in (by_month.By_Month, by_staff.By_Staff, retiree.Retiree):
