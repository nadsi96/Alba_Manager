...
#        return pandastable
    ...
    def update_Ledger_List(self):
        ...
        month = "{0:0>2}".format(self.top.selected_date.month)
...
#            month = str(month)
        ...
        for cursor in cursors:
            try:
                ...
                if "setted" in cursor["contents"][year][month].keys():
                    temp_dic["확정여부"] = cursor["contents"][year][month]["setted"]
                else:
                    temp_dic["확정여부"] = "-"
